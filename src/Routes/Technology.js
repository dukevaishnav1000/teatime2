...
class SpecificTopics extends React.Component{
    ...
    fetchHomeData(){
        ...
        fetch(`https://api.allorigins.win/get?url=${encodeURIComponent("https://newsapi.org/v2/everything?q=technology&pageSize=30&apiKey=ca7e73b85d284f8094f30683304ad991")}`).then((res)=>{
                        return res.json();             
                       },rej=>{
